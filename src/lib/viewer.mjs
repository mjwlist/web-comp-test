  ...
  computeBoundingSphere(attr) {
    ...
    for (let i = offset, l = array.length; i < l; i += stride) {
      ...
      maxRadiusSq = Math.max(
        maxRadiusSq,
        this.bounds.center.squaredDistance(tempVec3$2)
      )
    }
  ...
  return {
    ...
    m(target, anchor) {
      ...
      div_resize_listener = add_resize_listener(
        div,
        /*div_elementresize_handler*/ ctx[13].bind(div)
      )
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$.update = () => {
    ...
    if (
      $$self.$$.dirty & /*renderer, aspect, clientWidth, clientHeight*/ 1292
    ) {
      if (renderer && aspect) {
...
customElements.define('vepple-viewer', Component)
